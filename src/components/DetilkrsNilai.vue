...
// Group detilkrs berdasar semester
    ...
    methods: {
        ...
        var url = `https://api-group13-prognet.manpits.xyz/api/detilkrs/detail/${mhs_id}`;
        ...
        var url = `https://api-group13-prognet.manpits.xyz/api/matakuliah/${detilkrs.matakuliah_id}`;
        var token = localStorage.getItem('token');
        var header = { 'Authorization': 'Bearer ' + token };
        var self = this;
